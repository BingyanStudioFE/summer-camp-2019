...
- [概述](https://wangdoc.com/webapi/canvas.html#概述)
- Canvas API：绘制图形
  - [路径](https://wangdoc.com/webapi/canvas.html#路径)
  - [线型](https://wangdoc.com/webapi/canvas.html#线型)
  - [矩形](https://wangdoc.com/webapi/canvas.html#矩形)
  - [弧线](https://wangdoc.com/webapi/canvas.html#弧线)
  - [文本](https://wangdoc.com/webapi/canvas.html#文本)
  - [渐变色和图像填充](https://wangdoc.com/webapi/canvas.html#渐变色和图像填充)
  - [阴影](https://wangdoc.com/webapi/canvas.html#阴影)
- Canvas API：图像处理
  - [CanvasRenderingContext2D.drawImage()](https://wangdoc.com/webapi/canvas.html#canvasrenderingcontext2ddrawimage)
  - [像素读写](https://wangdoc.com/webapi/canvas.html#像素读写)
  - [CanvasRenderingContext2D.save()，CanvasRenderingContext2D.restore()](https://wangdoc.com/webapi/canvas.html#canvasrenderingcontext2dsave，canvasrenderingcontext2drestore)
  - [CanvasRenderingContext2D.canvas](https://wangdoc.com/webapi/canvas.html#canvasrenderingcontext2dcanvas)
  - [图像变换](https://wangdoc.com/webapi/canvas.html#图像变换)
- `<canvas>` 元素的方法
  - [HTMLCanvasElement.toDataURL()](https://wangdoc.com/webapi/canvas.html#htmlcanvaselementtodataurl)
  - [HTMLCanvasElement.toBlob()](https://wangdoc.com/webapi/canvas.html#htmlcanvaselementtoblob)
- Canvas 使用实例
  - [动画效果](https://wangdoc.com/webapi/canvas.html#动画效果)
  - [像素处理](https://wangdoc.com/webapi/canvas.html#像素处理)
- [参考链接](https://wangdoc.com/webapi/canvas.html#参考链接)
